...
1. Nous pouvons définir des clés sur *plusieurs colonnes* et les colonnes peuventt être de *différents types* -- *entier*, *numérique*, *caractère*, *facteur*, *entier64* etc. Les types *liste* et *complexe* ne sont pas encore supportés.
