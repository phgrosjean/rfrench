...
* Nous pouvons subdiviser les lignes comme dans un `data.frame` - sauf que vous n'avez pas besoin d'utiliser `DT$` de façon répétitive puisque les colonnes dans le cadre d'un `data.table` sont vues comme si elles étaient des *variables*.
