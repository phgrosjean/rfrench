...
* `dcast` utilise la notation *formule*. Les variables du côté gauche (*LHS*) de la formule correspondent aux variables *id* et sur le côté droit (*RHS*) aux variables *measure*.
