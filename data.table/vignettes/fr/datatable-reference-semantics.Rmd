...
les deux (1) et (2) ont entraîné une copie profonde de l'ensemble du data.frame dans les versions de `R` < 3.1`. [Il a été copié plus d'une fois] (https://stackoverflow.com/q/23898969/559784). Pour améliorer les performances en évitant ces copies redondantes, *data.table* a utilisé l'opérateur [disponible mais inutilisé `:=` dans R](https://stackoverflow.com/q/7033106/559784).
...
#### -- Supprimer la colonne `delay` (délai)
